            ...
            <div class="card">
                <div class="card-body flex flex-col p-6">
                    <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                        <div class="flex-1">
                            <div class="card-title text-slate-900 dark:text-white">Sector

                                <a href="{{ url('catalogo/sector') }}">
                            ...
                            <div class="space-y-5">
                                <div class="grid grid-cols-12 gap-5">
                                    ...
                                    <div class="xl:col-span-6 col-span-12 lg:col-span-8">
                                        ...
                                        @endif
                                        <form method="POST" action="{{ route('sector.update', $sector->Id) }}" enctype="multipart/form-data">
                                            @method('PUT')
                                            @csrf
                                            ...
                                            <div class="card h-full">
                                                <div class="grid pt-4 pb-3 px-4">
                                                    <div class="input-area relative">
                                                        ...
                                                        <input type="text" name="Nombre" value="{{ $sector->Nombre }}" class="form-control">
                                                    </div>                                                 
