                            ...
                            <div class="space-y-5">
                                <div class="grid grid-cols-12 gap-5">
                                    ...
                                    <div class="xl:col-span-6 col-span-12 lg:col-span-8">
                                        ...
                                        @endif
                                        <form method="POST" action="{{ route('profesion.update', $profesion->Id) }}" enctype="multipart/form-data">
                                            @method('PUT')
                                            @csrf
                                            ...
                                            <div class="card h-full">
                                                <div class="grid pt-4 pb-3 px-4">
                                                    <div class="input-area relative">
                                                        ...
                                                        <input type="text" name="Nombre" value="{{ $profesion->Nombre }}" class="form-control">
                                                    </div>                                                 
