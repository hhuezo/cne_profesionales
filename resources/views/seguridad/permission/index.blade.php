                        ...
                        <div class="overflow-hidden ">
                            <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700"
                                ...
                                <thead class=" border-t border-slate-100 dark:border-slate-800">
                                    <tr class="td-table">
                                        <th scope="col" class="table-th" style="text-align: center">Id</th>
                                        ...
                                        @foreach ($permissions as $obj)
                                            <tr class=" {{ $i % 2 == 0 ? 'td-table' : '' }}">
                                                ...
                                                <td class="table-td " align="center">
                                                    ...
                                                    &nbsp;&nbsp;
                                                        <iconify-icon data-bs-toggle="modal" data-bs-target="#modal-delete-{{ $obj->id }}" icon="mdi:trash" style="color: #1769aa;"
