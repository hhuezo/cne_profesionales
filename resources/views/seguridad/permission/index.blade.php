                                        ...
                                        @foreach ($permissions as $obj)
                                            <tr class="table-td {{ $i % 2 == 0 ? 'td-table' : '' }}">
                                                ...
                                                <td class="table-td " align="center">                                                    
                                                    <a href="{{ url('seguridad/permission') }}/{{ $obj->id }}/edit"
                                                        class="on-default edit-row">
                                                        <iconify-icon icon="mdi:pencil-box" style="color: #1769aa;" width="40"></iconify-icon></a>

                                                    &nbsp;&nbsp;<a href=""
                                                        data-target="#modal-delete-{{ $obj->id }}"
                                                        data-toggle="modal"><iconify-icon icon="mdi:trash" style="color: #1769aa;" width="40"></iconify-icon></a>
