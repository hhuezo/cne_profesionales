                            ...
                            <div class="card-body flex flex-col p-6">
                                ...
                                <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
                                        ...
                                        <header class="flex items-center border-b border-slate-100 dark:border-slate-700">
                                            <div class="flex-1">
                                                <div class="card-title text-slate-900 dark:text-white">Dirección actual
                                                </div>
                                            </div>
                                        </header>
                                        ...
                                        <div class="input-area">
                                            <label for="Profesion" class="form-label">Lugar de formación en eficiencia
                                                energética</label>
                                            <select class="form-control" name="LugarFormacion" id="LugarFormacion">
                                                <option value="0">Seleccione</option>
                                                @foreach ($lugares_formacion as $obj)
                                                    <option value="{{ $obj->Id }}"
                                                        {{ old('LugarFormacion') == $obj->Id ? 'selected' : '' }}>
                                                        {{ $obj->Nombre }}</option>
                                                @endforeach
                                            </select>
                                        </div>
